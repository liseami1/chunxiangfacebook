...
//  FantasyWindow
//
//  Created by 赵翔宇 on 2022/3/10.
//

public let GoldenH: CGFloat = Cell * 42
public let Cell: CGFloat = SCREEN_WIDTH / 390
public let userPrivacy1: AttributedString = .init("""
...
public let userPrivacy2: AttributedString = .init("""
...
电子邮件：liseami@qq.com,zhaoxiangyuliseami@gmail.com
...
var DateFormatter: DateFormatter {
    ...
    dateFormatter.locale = .init(identifier: "zh-hans")
    return dateFormatter
}

var PF_weekdaySymbols: [String] {
    return DateFormatter.shortWeekdaySymbols.moveFristToLast()
}
...
// 顶部安全区高度
public var SAFEAREA_TOP_HEIGHT: CGFloat {
    let window = AppWindow
...
public func MakeNaviBarAppearance(color: Color) -> UINavigationBarAppearance {
    let appearance = UINavigationBarAppearance()
    appearance.shadowColor = UIColor(color)
